    ...
    <div className="container border-top mt-5">
      ...
      <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
        ...
        <div className="container text-center">
            <a href="" className="mx-2 text-muted" style={{textDecoration:"none"}}>NSE​</a>
            <a href="" className="mx-2 text-muted" style={{textDecoration:"none"}}>BSE</a>
            <a href="" className="mx-2 text-muted" style={{textDecoration:"none"}}>MCX​</a>
            <a href="" className="mx-2 text-muted" style={{textDecoration:"none"}}>Terms & conditions​</a>
            <a href="" className="mx-2 text-muted" style={{textDecoration:"none"}}>Policies & procedures​</a>
            <a href="" className="mx-2 text-muted" style={{textDecoration:"none"}}>Privacy policy​</a>
            <a href="" className="mx-2 text-muted" style={{textDecoration:"none"}}>Disclosure​</a>
            <a href="" className="mx-2 text-muted" style={{textDecoration:"none"}}>For invester's attention​</a>
            <a href="" className="mx-2 text-muted" style={{textDecoration:"none"}}>Invester charter</a>
        </div>
        <br/>
    </div>
    </footer>
